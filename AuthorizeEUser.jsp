...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article"> 
          <h2 class="style4" style="color:#CC6600">Authorize Ecommerce Website Users..</h2>
          <div class="clr"></div>          
		  ...
		  <table width="570" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    <tr>
					  ...
					  <td  width="47"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56 style5"><b>Transport Company</b></div></td>
                      <td  width="47"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56 style5"><b>Email</b></div></td>
                    ...
                    <tr>
                      ...
                      <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style2"><a href="Admin_UserStatus.jsp?type=<%="elogin"%>&id=<%=i%>" class="style5">waiting</a></div>
                      </div></td>
                      <%
						}
						else
						{
						%>
                      <td width="17" height="0" align="center"  valign="middle"><div align="center" class="style7">
                        <b><%out.println(s5);%></b>
                      </div></td>
                      <%
						}
