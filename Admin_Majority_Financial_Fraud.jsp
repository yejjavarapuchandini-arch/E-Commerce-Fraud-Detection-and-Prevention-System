...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 align="center"><a href="index.html" class="style1">E-COMMERCE FRAUD DETECTION & PREVENTION SYSTEM</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article"> 
          <h2 class="style4" style="color:#CC6600">Financial Fraud Details...</h2>
          <div class="clr"></div>          
	...
	String s0="",s1="",s2="",s3="",s4="",s5="",s6="",s7="",fraud_tp="";
	...
	try
	{
	  	    ...
	  	    <table width="572" border="1">
				  <tr bgcolor="#FFFFFF">
				    <td colspan="8" ><h2 class="style6" style="color:#006666" ><span class="style11">Fraud Type :</span> 
                      ...
                      <td  width="109" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style10">Fraud Amount</div></td>
					  <td  width="105" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style10">WebSite</div></td>
				 ...
				 String query="select * from financial_fraud where fraud_type='"+"Wrong CVV"+"' and bank='"+bank+"'"; 
	     ...
	     <%
			       ...
			       %></table> 			
				   <form action="Admin_MajorityFraud.jsp" method="post">
				   <input type="hidden" name="ft" value="<%="Wrong CVV"%>" readonly />
				   <input name="Submit" type="submit" value="View Majority Fraud" />
				   </form>	   
	...
	<p>&nbsp;</p>
	  	    ...
	  	    <table width="572" border="1">
				 ...
				 <%
							...
							String query1="select * from financial_fraud where fraud_type='"+"Expired Card"+"' and bank='"+bank+"'"; 
	     ...
	     <%
			       ...
			       %></table>
				   	<form action="Admin_MajorityFraud1.jsp" method="post">
					 <input type="hidden" name="ft" value="<%="Expired Card"%>" readonly />
			  		<input name="Submit" type="submit" value="View Majority Fraud" />
			  		</form>
