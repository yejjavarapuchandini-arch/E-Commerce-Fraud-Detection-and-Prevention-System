...
<div class="main">
  ...
  <div class="content">
	...
	try
	{
			String sql3="select distinct fraud_type from financial_fraud where site='"+site+"' ";
			Statement st3=connection.createStatement();
			  ResultSet rs3=st3.executeQuery(sql3);
			while ( rs3.next() )
			   {
			   fraud_tp=rs3.getString(1);
			...
			%>
	  	    ...
	  	    <table width="572" border="1">
				  ...
				  <%
						   	...
						   	String query="select * from financial_fraud where fraud_type='"+fraud_tp+"' and site='"+site+"'"; 
	...
	%></table>
			  ...
			  <form action="Ecommerce_FindFraudsInChart.jsp" method="post">
			  <input name="Submit" type="submit" value="Show in Chart" />
			  </form>
