...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article"> 
          <h2 class="style4" style="color:#CC6600">Authorize Users..</h2>
          <div class="clr"></div>          
          ...
          <table width="560" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            ...
            <tr>
              ...
              <td width="140" rowspan="1" align="center" valign="middle" ><div style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                  <input  name="image" type="image" src="get_Pic.jsp?picture=<%="userimage"%>&id=<%=i%>" style="width:100px; height:100px;" />
              </a></div></td>
              ...
              <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center">
                  <div align="center" class="style20 style37 style46"><a href="Admin_UserStatus.jsp?type=<%="login"%>&name=<%=s1%>" class="style5"><b>waiting</b></a></div>
              </div></td>
              <%
						}
						else
