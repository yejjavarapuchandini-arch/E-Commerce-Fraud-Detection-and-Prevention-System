...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article"> 
          <h2 class="style4" style="color:#CC6600">Invalid Login Details, Please Try Again!!</h2>
          <div class="clr"></div>          
          <div class="post_content">
            ...
            <form id="form1" name="form1" method="post" action="Authentication.jsp?type=<%="bankadmin"%>">
					<table width="464" border="0" cellspacing="2" cellpadding="2">
						<tr>
            <td width="170" height="33"><div align="justify"><span class="style3">Select Bank (required)</span></div></td>
                        <td width="274"><label>
                          <select name="bank">
                  ...
                  <option>Indian Bank</option>
                      ...
                      <tr>
                        <td width="200" height="46" align="center"><div align="justify"><span class="style34">
                          <label for="name"><span class="style3">Bank Admin Name (required)</span></label>
                        </span></div> </td>
                        <td width="253"><input id="name" name="adminid" class="text" /></td>
                      </tr>
                      <tr>
                        <td height="30" align="center"><div align="justify"><span class="style3"><label for="pass"><span class="style3">Password (required)</span></label>
                        </span></div></td>
